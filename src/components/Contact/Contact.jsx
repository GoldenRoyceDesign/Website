...
const ContactUs = () => {
  return (
    <div>
      <div class="my-6">
            <div class="max-w-6xl mx-auto border bg-[#ff5350] rounded-lg">
                <div class="grid md:grid-cols-2 items-center gap-16 sm:p-10 p-4 font-[sans-serif]">
                    <div>
                        ...
                        <ul class="flex mt-12 space-x-4">
                            <li class="bg-[#ff5350] hover:bg-[#ff5350] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                    ...
                    <div class="bg-gray-200 p-6 rounded-lg">
                        ...
                        <div class="space-y-4 max-lg:mt-4">
                            <button type="button" class="px-4 py-2 rounded-md bg-[#ff5350] text-white text-sm tracking-wider font-medium outline-none border-2 border-[#a91079] mr-4">Web design</button>
                        ...
                        <form class="mt-8 space-y-4">
                            <input type='text' placeholder='Name'
                                class="w-full rounded-md py-3 px-4 text-sm outline-[#ff5350]" />
                            <input type='email' placeholder='Email'
                                class="w-full rounded-md py-3 px-4 text-sm outline-[#ff5350]" />
                            <input type='text' placeholder='Subject'
                                class="w-full rounded-md py-3 px-4 text-sm outline-[#ff5350]" />
                            <textarea placeholder='Message' rows="6"
                                class="w-full rounded-md px-4 text-sm pt-3 outline-[#ff5350]"></textarea>
                            <button type='button'
                                class="text-white bg-[#ff5350] hover:bg-[#ff5350] font-semibold rounded-md text-sm px-4 py-3 flex items-center justify-center w-full">
